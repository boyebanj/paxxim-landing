<template>
  <div class="TeamsHeader_TeamsHeader__ZrB9S">
    <!-- Circles + orbiting icons/avatars -->
    <div class="TeamsHeader_circleContainer__0WUkw">
      <div class="TeamsHeader_circles__eX11d">
        <!-- circle-1 -->
        <svg xmlns="http://www.w3.org/2000/svg" width="764" height="764" fill="none">
          ...
          <defs>
            <linearGradient id="circle-1_svg__b" x1="2" x2="762" y1="2" y2="762" gradientUnits="userSpaceOnUse">
              ...
              <stop offset="0.302" stop-color="#fff" stop-opacity="0.396" />
              <stop offset="0.427" stop-color="#fff" />
              <stop offset="0.568" stop-color="#fff" stop-opacity="0" />
              <stop offset="0.682" stop-color="#fff" stop-opacity="0.66" />
              <stop offset="0.807" stop-color="#fff" stop-opacity="0.29" />
              <stop offset="0.899" stop-color="#fff" stop-opacity="0.37" />
            </linearGradient>
            <filter
              id="circle-1_svg__a"
              width="764"
      ...
      <!-- Anchored avatars + inline icons -->
      <div class="TeamsHeader_circleAnchors__KLg1Q">
        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateLeft__VwO7v" style="width:382px;--rotation:205deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <img :src="profileSrc(1)" alt="photo of random team member" width="28" height="28" />
          </div>
        </div>

        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateLeft__VwO7v" style="width:382px;--rotation:335deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <img :src="profileSrc(2)" alt="photo of random team member" width="21" height="21" />
          </div>
        </div>

        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateRight__2sZMt" style="width:302px;--rotation:25deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <img :src="profileSrc(3)" alt="photo of random team member" width="21" height="21" />
          </div>
        </div>

        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateRight__2sZMt" style="width:302px;--rotation:315deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <img :src="profileSrc(4)" alt="photo of random team member" width="21" height="21" />
          </div>
        </div>

        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateRight__2sZMt" style="width:462px;--rotation:145deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <img :src="profileSrc(5)" alt="photo of random team member" width="24" height="24" />
          </div>
        </div>

        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateRight__2sZMt" style="width:302px;--rotation:145deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <img :src="profileSrc(6)" alt="photo of random team member" width="21" height="21" />
          </div>
        </div>

        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateLeft__VwO7v" style="width:382px;--rotation:110deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <img :src="profileSrc(7)" alt="photo of random team member" width="32" height="32" />
          </div>
        </div>

        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateRight__2sZMt" style="width:462px;--rotation:230deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <img :src="profileSrc(8)" alt="photo of random team member" width="40" height="40" />
          </div>
        </div>

        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateRight__2sZMt" style="width:462px;--rotation:315deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <img :src="profileSrc(9)" alt="photo of random team member" width="40" height="40" />
          </div>
        </div>

        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateLeft__VwO7v" style="width:382px;--rotation:275deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <img :src="profileSrc(10)" alt="photo of random team member" width="28" height="28" />
          </div>
        </div>

        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateLeft__VwO7v" style="width:382px;--rotation:45deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <img :src="profileSrc(11)" alt="photo of random team member" width="32" height="32" />
          </div>
        </div>

        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateRight__2sZMt" style="width:462px;--rotation:5deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <div>
              <i style="opacity: 1;">
                <i class="TeamsHeader_circleHoverTarget____Uvw">
        ...
        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateRight__2sZMt" style="width:462px;--rotation:75deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <div>
              <i style="opacity: 1;">
                <i class="TeamsHeader_circleHoverTarget____Uvw">
        ...
        <div class="TeamsHeader_circleIconWrapper__FvyTs TeamsHeader_rotateRight__2sZMt" style="width:462px;--rotation:185deg">
          <div class="TeamsHeader_circleIcon__XG3xj">
            <div>
              <i style="opacity: 1;">
                <i class="TeamsHeader_circleHoverTarget____Uvw">
                  <!-- Sliders icon -->
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" class="icon">
                    <path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="M11.75 2.75h1.5m-10.5 0h5.5m.5 10.5h4.5m-10.5 0h2.5m-2.5-3.5h4.5m3.5 0h2.5m-10.5-3.5h1.5m3.5 0h5.5" />
                  </svg>
                </i>
              </i>
            </div>
    ...
    <!-- Header content -->
    <div class="TeamsHeader_headerContent__ceTPP">
      <a href="https://www.producthunt.com/posts/paxxim-for-teams" target="_blank" rel="noreferrer" class="TeamsHeader_pill__lsulA">
        Featured on Product Hunt
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5.75 3.75 10.25 8l-4.5 4.25" />
        </svg>
      </a>
      ...
      <a href="#learn-more" class="TeamsHeader_learnMore__Tce6T">
        Learn more
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" class="icon TeamsHeader_arrowDown__rKHtB">
    ...
    <!-- Background overlay -->
    <div class="TeamsHeader_headerBg__HvIGw"></div>
  </div>
</template>

<script setup lang="ts">
import p1 from '@/assets/images/profile-1.png'
import p2 from '@/assets/images/profile-2.png'
import p3 from '@/assets/images/profile-3.png'
import p4 from '@/assets/images/profile-4.png'
import p5 from '@/assets/images/profile-5.png'
import p6 from '@/assets/images/profile-6.png'
import p7 from '@/assets/images/profile-7.png'
import p8 from '@/assets/images/profile-8.png'
import p9 from '@/assets/images/profile-9.png'
import p10 from '@/assets/images/profile-10.png'
import p11 from '@/assets/images/profile-11.png'
